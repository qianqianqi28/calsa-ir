#Same as the calsa-tc/Wilhelmus data fold in/code/Wilhelmus create matrix/nrowL2dtmWilhelmusdataset.R

#Copy from the calsa-tc/Wilhelmus data fold in/code/Wilhelmus create matrix/nrowL2dtmWilhelmusdataset.R. In order to run the code in the same folder, we modify the path of data


#This code is for songs from six authors using LOOCV. Note each time 185 documents from training set form a nrowl2 document-term matrix of size 185*300 and the single document of validation set is not included in the matrix.
