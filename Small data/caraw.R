#For second paper: Figure 1 (b); this code is about CA for small dataset: 6*6 toy dataset
...
#Figure 1b: Symmetric map of the data of Table 1.
...
dev.off()
setEPS()
postscript("C:\\Users\\qi000005\\OneDrive - Universiteit Utrecht\\qi000005\\paper 2\\Small data\\figure\\caraw.eps")
