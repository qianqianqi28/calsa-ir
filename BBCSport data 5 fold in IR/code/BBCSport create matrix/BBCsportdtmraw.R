#Same as the calsa-tc/BBCSport data 5 fold in/code/BBCSport create matrix/BBCsportdtmraw.R

#Copy from the calsa-tc/BBCSport data 5 fold in/code/BBCSport create matrix/BBCsportdtmraw.R. In order to run the code in the same folder, we modify the path of data

#This code is for 737 documents from five categories using five-fold cross validation. Note each time the documents from the training set form a raw document-term matrix and the documents of validation set are not included in the matrix.
...
# Define a function to read all files from a folder into a data frame
alldata_folder <- "C:/Users/qi000005/OneDrive - Universiteit Utrecht/qi000005/paper 2/BBCSport data 5 fold in IR/data/bbcsport/"
...
save(training_dtm, testing_dtm, training_index, testing_index, file = "C:\\Users\\qi000005\\OneDrive - Universiteit Utrecht\\qi000005\\paper 2\\BBCSport data 5 fold in IR\\created data\\created matrix\\rawdtmBBCsport.Rdata")
